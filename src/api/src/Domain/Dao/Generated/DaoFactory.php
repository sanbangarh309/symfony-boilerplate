...
class DaoFactory implements \Symfony\Contracts\Service\ServiceSubscriberInterface
{
    ...
    /**
     * @var \App\Domain\Dao\PaymentDao|null
     */
    private $paymentDao = null;
    ...
    public function getPaymentDao() : \App\Domain\Dao\PaymentDao
    {
        if (!$this->paymentDao) {
            $this->paymentDao = $this->container->get('App\\Domain\\Dao\\PaymentDao');
        }

        return $this->paymentDao;
    }

    public function setPaymentDao(\App\Domain\Dao\PaymentDao $paymentDao) : void
    {
    ...
    public static function getSubscribedServices() : array
    {
        return [
            ...
            'App\\Domain\\Dao\\PaymentDao' => 'App\\Domain\\Dao\\PaymentDao',
