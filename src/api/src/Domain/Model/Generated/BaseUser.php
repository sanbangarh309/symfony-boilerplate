...
abstract class BaseUser extends \TheCodingMachine\TDBM\AbstractTDBMObject implements JsonSerializable
{
    ...
    /**
     * Returns the Payment pointing to this bean via the user_id column.
     *
     * @
     */
    public function getPayment() : ?\App\Domain\Model\Payment
    {
        return $this->retrieveManyToOneRelationshipsStorage('payments', 'from__user_id__to__table__users__columns__id', ['payments.user_id' => $this->get('id', 'users')], null, \App\Domain\ResultIterator\PaymentResultIterator::class)->first();
    }
