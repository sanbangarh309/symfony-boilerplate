<template>
  <div>
    ...
    >
      <Column
        field="createdAt"
        :header="$t('components.payment.list.createdAt')"
      ></Column>
      <Column
        field="amount"
        :header="$t('components.payment.list.amount')"
      ></Column>
      <Column
        field="label"
        :header="$t('components.payment.list.label')"
      ></Column>
      <Column
        field="localization"
        :header="$t('components.payment.list.action')"
      >
...
const { data: payments } = await useListPayments();
...
// Listen to the event on mount
emitter.on('loadPayments', loadPayments);
